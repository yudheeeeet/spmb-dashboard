...
<head>
    ...
    <style>
        ...
        * {
        ...
        .author-dropdown-container.active .dropdown-arrow {
        ...
        .dark .author-dropdown-content {
            background: rgba(30, 41, 59, 0.95);
            border-color: rgba(255, 255, 255, 0.1);
            box-shadow: 0 10px 25px rgba(0, 0, 0, 0.3);
        }

        .light .author-dropdown-content {
...
<body>
    ...
    <header>
        <div class="header-title">
            ...
            <div class="header-info">
                <h1>Sistem Monitoring - Kawal SPMB SMP Kota Bogor 2026</h1>
        ...
        <div class="header-badges">
            ...
            <div class="author-dropdown-container">
                <button class="author-dropdown-btn" id="about-us-btn">
                    <span>Tentang Kami</span> <span class="dropdown-arrow">▼</span>
                </button>
                <div class="author-dropdown-content" id="about-us-dropdown">
                    <div class="author-title">Pengembang Dashboard</div>
                    <div class="author-list">
                        <div class="author-item">
                            <span class="author-bullet">👤</span>
                            <span class="author-name">Sachnaz Desta Oktarina S.Stat., M.Agr.Sc., Ph.D</span>
                        </div>
                        <div class="author-item">
                            <span class="author-bullet">👤</span>
                            <span class="author-name">Rachmat Bintang Yudhianto S.Kom., M.Si.</span>
                        </div>
                    </div>
                    ...
                    <div class="author-affiliation">
                        ...
                        <div class="aff-text">
                            <strong>Sekolah Sains Data, Matematika, dan Informatika</strong><br>
                            IPB University
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const dropdownContainer = document.querySelector('.author-dropdown-container');
        ...
        function exportCurrentToExcel() {
            alert('Fitur ekspor dinonaktifkan sementara demi etika penggunaan data dashboard.');
            return;
            if (filteredApplicants.length === 0) {
